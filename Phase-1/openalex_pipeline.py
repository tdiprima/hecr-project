...
class OpenAlexAPI:
    ...
    def get_author_publications(self, author_id: str, max_results: int = 10) -> List[Publication]:
        """
...
class PDFProcessor:
    ...
    def summarize_text(self, text: str, max_length: int = 150) -> Optional[str]:
        ...
        try:
            ...
            summary = self.summarizer(text_chunk, max_length=max_length, min_length=30, do_sample=False)
...
def run_pipeline(email: Optional[str] = None, num_authors: int = 3, num_pubs: int = 2):
    ...
    for idx, author in enumerate(authors):
        ...
        for pub_idx, pub in enumerate(publications):
            ...
            if pub.abstract:
                abstract_preview = pub.abstract[:200] + "..." if len(pub.abstract) > 200 else pub.abstract
...
if __name__ == "__main__":
    ...
    print("Install dependencies: pip install requests PyPDF2 pdfplumber transformers torch\n")
